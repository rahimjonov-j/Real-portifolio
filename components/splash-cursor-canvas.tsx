...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    class Material {
      ...
      programs: (WebGLProgram | null | undefined)[];
    ...
    function render(target: { fbo: WebGLFramebuffer; width: number; height: number } | null) {
      gl.blendFunc(gl.ONE, gl.ONE_MINUS_SRC_ALPHA);
      gl.enable(gl.BLEND);
      drawDisplay(target);
    }

    function drawDisplay(target: { fbo: WebGLFramebuffer; width: number; height: number } | null) {
    ...
    function clickSplat(pointer: Pointer) {
      ...
      const color = { r: colorArr[0] * 10.0, g: colorArr[1] * 10.0, b: colorArr[2] * 10.0 };
    ...
    function handleMouseMove(e: MouseEvent) {
      ...
      if (!firstMouseMoveHandled) {
        ...
        updatePointerMoveData(pointer, posX, posY, { r: colorArr[0], g: colorArr[1], b: colorArr[2] });
